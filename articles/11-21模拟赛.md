...
<button id="treasurebtn" onclick="showCode('treasure')">展开代码</button>
<div id="treasure" class="code" style="height: 0px;">
...
<button onclick="showCode('path')">显示代码</button>
<div id="path" class="code" style="height: 0px;">
