...
<button id="T1btn" onclick="showCode('T1')">展开代码</button>
<div id="T1" class="code" style="height: 0px;">
...
<button id="T2btn" onclick="showCode('T2')">展开代码</button>
<div id="T2" class="code" style="height: 0px;">
